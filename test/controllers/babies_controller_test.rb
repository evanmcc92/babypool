...
class BabiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create baby" do
    assert_difference('Baby.count') do
      post babies_url, params: { baby: { admin_id: @baby.admin_id, description: @baby.description, due_date: @baby.due_date, links: @baby.links, title: @baby.title } }
    end
  ...
  test "should update baby" do
    patch baby_url(@baby), params: { baby: { admin_id: @baby.admin_id, description: @baby.description, due_date: @baby.due_date, links: @baby.links, title: @baby.title } }
